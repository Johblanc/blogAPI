...
export class UsersService{
    ...
    async add(name : string, hash : string, adminLvl : number) : Promise<TUser | undefined>
    {
        const data : QueryResult<TUser> = await client.query('INSERT INTO users (name, password,admin_lvl) VALUES ($1,$2,$3) RETURNING *', [name, hash, adminLvl]);
